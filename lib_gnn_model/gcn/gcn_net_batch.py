...
class GCNNet(torch.nn.Module):
    def __init__(self, num_feats, num_classes, num_layers=2, for_link_pred=False):
        ...
        for _ in range(num_layers - 2):
            self.convs.append(GCNConvBatch(16, 16, cached=False, add_self_loops=True, bias=False))
        if not for_link_pred:

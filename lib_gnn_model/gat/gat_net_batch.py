...
class GATNet(torch.nn.Module):
    def __init__(self, num_feats, num_classes, dropout=0.6, num_layers=2, for_link_pred=False):
        ...
        for _ in range(num_layers - 2):
            self.convs.append(GATConv(8 * 8, 8 * 8, heads=1, concat=False, dropout=self.dropout, add_self_loops=True))
